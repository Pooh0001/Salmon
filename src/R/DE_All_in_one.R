#' ---
#' title: "Differential Expression of either LamV, WNV or dual-infection vs mock in U4.4 cells"
...
"extract_results" <- function(dds,vst,contrast,
                              ...
                              export=TRUE,default_dir=here("data_new_All/analysis/DE"),
                              default_prefix="DE-",
                              labels=colnames(dds),
...
extractEnrichmentResults <- function(enrichment,task="go",
                                     ...
                                     default_dir=here("data_new_All/analysis/DE"),
                                     default_prefix="DE",
                                     url="athaliana"){
  # process args
...
#' #### DE transcripts in common between all infections at 24h post WNV infection and 48h post LamV infection.
 
res.list=list(LamVvsMock48=LamVvsMock48,
              WNVvsMock48=WNVvsMock48,
              LamVWNVvsMock48=LamVWNVvsMock48)
...
#' #### DE transcripts in common between all infections at 48h post WNV infection and 72h post LamV infection

res.list=list(LamVvsMock72=LamVvsMock72,
              WNVvsMock72=WNVvsMock72,
              LamVWNVvsMock72=LamVWNVvsMock72)
...
#' DE transcripts in common between all time points post LamV infection. 

res.list=list(LamVvsMock24=LamVvsMock24,
              LamVvsMock48=LamVvsMock48,
              LamVvsMock72=LamVvsMock72)
...
#' DE transcripts in common between all time points post WNV infection. 

res.list=list(WNVvsMock48=WNVvsMock48,
              WNVvsMock72=WNVvsMock72)
...
res.list=list(LamVWNVvsMock48=LamVWNVvsMock48,
              LamVWNVvsMock72=LamVWNVvsMock72)
